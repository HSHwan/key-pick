# Generated by Django 5.2.8 on 2025-11-13 09:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "branch_name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="지점명"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "login_id",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="로그인 ID"
                    ),
                ),
                ("name", models.CharField(max_length=50, verbose_name="이름")),
                (
                    "phone",
                    models.CharField(max_length=20, unique=True, verbose_name="연락처"),
                ),
                (
                    "role",
                    models.CharField(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="booking.branch",
                        verbose_name="대상 지점 (전체 공지 시 NULL)",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_price",
                    models.DecimalField(
                        decimal_places=0, max_digits=10, verbose_name="최종 결제액"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "hint_count",
                    models.IntegerField(default=0, verbose_name="힌트 사용 횟수"),
                ),
                (
                    "is_success",
                    models.BooleanField(
                        blank=True, null=True, verbose_name="탈출 성공 여부"
                    ),
                ),
                (
                    "clear_time",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="클리어 시간 (초)"
                    ),
                ),
                (
                    "member",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_method",
                    models.CharField(max_length=50, verbose_name="결제 수단"),
                ),
                (
                    "amount",
                    models.DecimalField(
                ...
                (
                    "payment_status",
                    models.CharField(max_length=20, verbose_name="결제 상태"),
                ),
                (
                    "paid_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="결제 시각"),
                ),
                (
                    "reservation",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price",
                    models.DecimalField(
                        decimal_places=0, max_digits=10, verbose_name="기본 가격"
                    ),
                ),
                (
                    "discount_rate",
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("Ready", "운영 가능"), ("Maintenance", "점검 중")],
                        default="Ready",
                        max_length=20,
                        verbose_name="테마 상태",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reported_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="보고 시각"),
                ),
                (
                    "reported_by_member",
                    models.ForeignKey(
